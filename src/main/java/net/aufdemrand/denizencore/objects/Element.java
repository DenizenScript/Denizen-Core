...
import net.aufdemrand.denizencore.scripts.containers.core.FormatScriptContainer;
import net.aufdemrand.denizencore.scripts.containers.core.ItemScriptHelper;
